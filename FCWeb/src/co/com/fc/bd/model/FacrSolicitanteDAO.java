 ...
 * FacrSolicitante entities. Transaction control of the save(), update() and
...
public class FacrSolicitanteDAO extends BaseHibernateDAO {
	...
	public FacrSolicitante findById(java.lang.String id) {
		...
		try {
			FacrSolicitante instance = (FacrSolicitante) getSession().get(
					"co.com.fc.bd.model.FacrSolicitante", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(FacrSolicitante instance) {
		...
		try {
			List results = getSession().createCriteria(
					"co.com.fc.bd.model.FacrSolicitante").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding FacrSolicitante instance with property: "
	...
	public FacrSolicitante merge(FacrSolicitante detachedInstance) {
		...
		try {
			FacrSolicitante result = (FacrSolicitante) getSession().merge(
					detachedInstance);
