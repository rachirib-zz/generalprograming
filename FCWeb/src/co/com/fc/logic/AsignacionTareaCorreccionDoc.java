...
public class AsignacionTareaCorreccionDoc implements AssignmentHandler {

	public void assign(Assignable assignable, ExecutionContext executionContext)
			throws Exception {
		
		//String[] userId = (String[]) executionContext.getVariable("actorAssigment");
		System.out.println("############ ASIGNANDO TAREA DE CORRECION DE DOCUMENTOS ####");
		assignable.setActorId("pgomez");
